 ...
 * @params callback {Function}
 */
Feedly.prototype.getEntries = function(ids, callback) {
  if (!callback) {
    callback = ids;
    ids = null;
  }
  ...
  var api_path = 'entries';
  var api_action = '.mget';
  var putBody = {
    ids: ids
  };
  this._post(this._buildUrl(api_path, api_action), putBody, callback);
};
