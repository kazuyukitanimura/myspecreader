...
var sortComp = function(a, b) {
  return b.must - a.must || b.score - a.score || b.featureVector.engagementRate - a.featureVector.engagementRate || b.unexploredScore - a.unexploredScore || b.published - a.published;
};
    ...
    this.getStreams(options, function(err, data, response) {
      if (!err) {
        ...
        for (var i = items.length; i--;) {
          ...
          item.unexploredScore = scw.weightMatrix.countDefault(Object.keys(featureVector));
        }
