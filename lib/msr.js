    ...
    this.getStreams(options, function(err, data, response) {
      if (!err) {
        ...
        for (i = items.length; i--;) {
          item = items[i];
          console.log(item.title, item.featureVector.engagement, item.featureVector.engagementRate, item.score, scw.calcScores(item.featureVector)); // TODO delete this after debugging
