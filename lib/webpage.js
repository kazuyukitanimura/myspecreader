...
app.all('*', function(req, res) {
  ...
  if (host && host.indexOf('sfchickens.com') !== - 1) {
    res.render('sfchickens.html', {
      ...
      description: 'Tap to move the two SFChickens to catch and deliver the egg boxes conveyed on the belts. All egg boxes enter from the lower right belt. All survived egg boxes are loaded on truck (lower left). Try not to let any egg box drop. Catch and deliver as many egg boxes as you can! The game proceeds to the next level once 10 egg boxes are loaded on the truck. The game is over when 3 egg boxes are dropped. Each successful catch-and-deliver adds one point. You get bonus points when you reach 300 points. It is strategic and fun!',
